...
const mentors = [
  {
    id: "1",
    name: "Prof. Katherine Anderson",
    title: "Professor of Computer Science",
    institution: "Stanford University",
    location: "Palo Alto, CA, USA",
    avatar: "/placeholder.svg",
    expertise: ["Machine Learning", "Computer Vision", "Neural Networks"],
    bio: "Professor Anderson leads the Machine Learning Research Group at Stanford University. With over 15 years of experience in the field, she has supervised numerous PhD students and postdoctoral researchers who have gone on to successful careers in academia and industry.",
    publications: 78,
    hIndex: 42,
  ...
  },
  {
    ...
    bio: "Dr. Thompson's research focuses on developing computational methods for analyzing large-scale genomic data. He is passionate about mentoring early-career researchers and helping them navigate the interdisciplinary challenges of modern bioinformatics.",
    publications: 45,
    hIndex: 28,
  ...
  },
  {
    ...
    bio: "Dr. Wilson combines research in climate science with policy engagement. His mentoring approach emphasizes the importance of communicating scientific findings to policymakers and the public.",
    publications: 63,
    hIndex: 35,
    availability: "Open (multiple mentees)",
    mentoringSince: "2010",
  ...
  },
  {
    ...
    bio: "Dr. Johnson's research examines the neural basis of decision-making and learning. She is particularly interested in mentoring researchers who wish to combine psychological theory with advanced quantitative methods.",
    publications: 37,
    hIndex: 22,
    availability: "Limited (1-2 mentees)",
    mentoringSince: "2015",
